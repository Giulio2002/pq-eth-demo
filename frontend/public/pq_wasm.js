 ...
 * @returns {Uint8Array}
 */
export function dilithium_sign(secret_key, message) {
 ...
 * @returns {Uint8Array}
 */
export function falcon_decode_pk(pk_bytes) {
    const ptr0 = passArray8ToWasm0(pk_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.falcon_decode_pk(ptr0, len0);
 ...
 * @returns {Uint8Array}
 */
export function falcon_keygen() {
    const ret = wasm.falcon_keygen();
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
 ...
 * @returns {Uint8Array}
 */
export function falcon_sign(secret_key, message) {
    const ptr0 = passArray8ToWasm0(secret_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.falcon_sign(ptr0, len0, ptr1, len1);
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v3;
}
 ...
 * @returns {Uint8Array}
 */
export function falcon_sign_raw(secret_key, message) {
    const ptr0 = passArray8ToWasm0(secret_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.falcon_sign_raw(ptr0, len0, ptr1, len1);
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v3;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('pq_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
